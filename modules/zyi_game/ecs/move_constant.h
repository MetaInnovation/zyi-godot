...
protected:
	static void _bind_methods() {
		...
		BIND_BITFIELD_FLAG(MOVE_FLAG_ALWAYS_FOLLOW_BY_POS);
		BIND_BITFIELD_FLAG(MOVE_FLAG_BOIDS_GRID_SURROUND_FOLLOW);
	}
...
public:
	enum Flags : int16_t {
		...
		// 将 last_follow_pos 视为需要一直跟随的位置
		MOVE_FLAG_ALWAYS_FOLLOW_BY_POS = 64,
		// 自动计算 boid 包围力，基于 last_follow_pos
		MOVE_FLAG_BOIDS_GRID_SURROUND_FOLLOW = 128,
	};
};
